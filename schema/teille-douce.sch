...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   ...
   <!-- This file generated 2026-09-03T16:07:07Z by 'extract-isosch.xsl'. -->
   <!-- ********************* -->
   <!-- namespaces, declared: -->
   <!-- ********************* -->
   ...
   <pattern id="schematron-constraint-linkTargets3-26">
   ...
   <pattern id="schematron-constraint-abstractModel-structure-ab-in-l-27">
   ...
   <pattern id="schematron-constraint-noNestedS-28">
      <rule context="tei:s">
         <report test="tei:s">You may not nest one &lt;s&gt; element within another: use &lt;seg&gt; instead.</report>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-one_ms_singleton_max-29">
   ...
   <pattern id="schematron-constraint-msId_minimal-30">
   ...
   <pattern id="schematron-constraint-langUsage-langues-seules-31">
   ...
   <pattern id="schematron-constraint-language-quantite-32">
      <rule context="tei:langUsage/tei:language[@usage]">
   ...
   <pattern id="schematron-constraint-choice-orig-reg-33">
   ...
   <pattern id="schematron-constraint-pas-de-cesure-residuelle-34">
   ...
   <pattern id="schematron-constraint-entite-automatique-datee-35">
      <rule context="*[@resp = '#ner-auto']">
         <assert test="@cert"> An automatically detected entity must carry @cert (high, medium or low).</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-graphiczone-identifiee-36">
